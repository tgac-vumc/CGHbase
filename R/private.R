...
.getCentromere <- function(build) {
    ...
    if (build == 34 || build == 16) { # NCBI34 / hg16
        ...
        centromere[4, ] <- (48200000, 51800000)
        centromere[5, ] <- (46100000, 51400000)
        centromere[6, ] <- (58500000, 62600000)
        centromere[7, ] <- (58100000, 62100000)
        centromere[8, ] <- (43200000, 47200000)
        centromere[9, ] <- (42200000, 45500000)
        centromere[10, ] <- (38000000, 41600000)
        centromere[11, ] <- (51000000, 55800000)
        centromere[12, ] <- (33200000, 37800000)
        centromere[13, ] <- (16500000, 18900000)
        centromere[14, ] <- (16100000, 18200000)
        centromere[15, ] <- (17500000, 20500000)
        centromere[16, ] <- (35300000, 38400000)
        centromere[17, ] <- (22700000, 27400000)
        centromere[18, ] <- (15400000, 21500000)
        centromere[19, ] <- (24200000, 28100000)
        centromere[20, ] <- (25700000, 30400000)
        centromere[21, ] <- (10900000, 13000000)
        centromere[22, ] <- (13700000, 17400000)
        centromere[23, ] <- (58100000, 63800000)
        centromere[24, ] <- (10300000, 10600000)
    }
