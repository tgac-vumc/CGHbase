...
.getCentromere <- function(build) {
    ...
    if (build == 34 || build == 16) { # NCBI34 / hg16
        ...
        centromere[1, ] <- c(121700000, 125100000)
        centromere[2, ] <- c(91800000, 96000000)
        centromere[3, ] <- c(87800000, 94000000)
        centromere[4, ] <- c(48200000, 51800000)
        centromere[5, ] <- c(46100000, 51400000)
        centromere[6, ] <- c(58500000, 62600000)
        centromere[7, ] <- c(58100000, 62100000)
        centromere[8, ] <- c(43200000, 47200000)
        centromere[9, ] <- c(42200000, 45500000)
        centromere[10, ] <- c(38000000, 41600000)
        centromere[11, ] <- c(51000000, 55800000)
        centromere[12, ] <- c(33200000, 37800000)
        centromere[13, ] <- c(16500000, 18900000)
        centromere[14, ] <- c(16100000, 18200000)
        centromere[15, ] <- c(17500000, 20500000)
        centromere[16, ] <- c(35300000, 38400000)
        centromere[17, ] <- c(22700000, 27400000)
        centromere[18, ] <- c(15400000, 21500000)
        centromere[19, ] <- c(24200000, 28100000)
        centromere[20, ] <- c(25700000, 30400000)
        centromere[21, ] <- c(10900000, 13000000)
        centromere[22, ] <- c(13700000, 17400000)
        centromere[23, ] <- c(58100000, 63800000)
        centromere[24, ] <- c(10300000, 10600000)
    }
...
.getChromosomeLengths <- function(build) {
    ...
    if (build == 34 || build == 16) {
       ...
       chromosome.lengths <- c(249250621, 243199373, 198022430, 191154276, 180915260, 171115067, 159138663, 146364022, 141213431, 135534747, 135006516, 133851895, 115169878, 107349540, 102531392, 90354753, 81195210, 78077248, 59128983, 63025520, 48129895, 51304566, 155270560, 59373566)
        ...
        chromosome.lengths <- c(248956422,242193529,198295559,190214555,181538259, 170805979,159345973,145138636,138394717,133797422,135086622,133275309, 114364328,107043718,101991189,90338345,83257441,80373285,58617616,
